...
-----------1-10 Elwynn Forest
	...
	[0110] = {
		...
		items = {
			...
			[23] = { str = "#VIDEORun back to the Abbey (spawn)" },
			...
			[32] = { str = "#TURNINTurn in Rest and Relaxation to Innkeeper Farley (near the bar)                                                                                         \n#COORDS**Make Goldshire your home**" },
			[33] = { str = "#NPCExit the Inn and go to Marshal Dughan (next to blacksmithing building)                                                                                                                \n#TURNIN1) Turn in Report to Goldshire \n#ACCEPT2) Accept The Fargodeep Mine" },
			[34] = { str = "#NPC**Train skills**                                                                                   \nWarrior trainer at 41,66 (backside of BS building) \n#COORDSIf you're melee class, buy a weapon", x = 41, y = 66, zone = "Elwynn Forest"  },
			...
			[46] = { str = "#COORDS**Hearth to Goldshire**" },
			...
			[53] = { str = "#TURNIN1) Run to the bridge at 73,72 and turn in Further Concerns                             #ACCEPT2) Accept Find the Lost Guards  \n3) Accept Protect the Frontier", x = 73, y = 72, zone = "Elwynn Forest" },
			...
			[63] = { str = "#COORDSYou might find Furlbrow's Deed on the defias while you’re killing defias just hold it for now." },
...
-----------10-12 Westfall and Lock Modan
	...
	[1012] = {
		...
		--itemCount = 38,
		items = {
			[1] = { str = "#VIDEO10-12 Westfall and Loch Modan" },
			[2] = { str = "#NPC**If you found “Furlbrow’s Deed” in Elwynn, #TURNINturn it in at near #VIDEO(59,19)", x = 59, y = 19, zone = "Westfall" },
			[3] = { str = "#ACCEPT1) Accept “Westfall Stew”                                                                                                                                                                                                                                                               \n#ACCEPT2) Accept “Poor Old Blanchy”  \n#COORDS**Note on Ol Blanchy: You'll want to do this as we do the rest of the quests in this zone**" },
			[4] = { str = "#TURNIN1) Turn in “Westfall Stew” in the house near #VIDEO(56,30)                       \n#ACCEPT2) Accept The Killing Fields", x = 56, y = 30, zone = "Westfall" },
			[5] = { str = "#TURNIN1) Turn in “Report to Gryan Stoutmantle” at #VIDEO(56,47)                        \n#ACCEPT2) Accept The People's Militia (Part 1)", x = 56, y = 47, zone = "Westfall" },
			[6] = { str = "#ACCEPT1) Go in the tower and accept “A Swift Message”                                                          \n2) Run to the top of the tower and grab Patrolling Westfall" },
			...
			[8] = { str = "#ACCEPT1) Accept Red Leather Bandanas near the logging building next to the Inn near #VIDEO(54,53)                                                                                                                                                                                                                                                                       \n#DOQUEST2) Go do The People's Militia (Part 1) and Red Leather Bandanas directly West of Sentinel Hill", x = 54, y = 53, zone = "Westfall" },
			[9] = { str = "#DOQUESTDo The Forgotten Heirloom by looting the pocket watch in the armoire inside the house near #VIDEO(49,18)                                                                                                                                                                                                                                                                                                  \n#COORDS**If you're far ahead of the curve (or solo and a weak class) you might want to skip this, there's a lvl 15 in the house you have to kill or kite away**", x = 49, y = 18, zone = "Westfall" },
			[10] = { str = "#DOQUEST1) Do Patrolling Westfall by killing Gnolls around #VIDEO(45,15)                                                                                                                                                                                       \n#TURNIN2) Turn in Ol' Blanchy near the entrance to the zone \n3) Turn in The Forgotten Heirloom", x = 45, y = 15, zone = "Westfall" },
			[11] = { str = "#NPC1) Run back to Sentinel Hill                                                                                                                                                                                                                                                                                                                                                                                          \n#TURNIN2) Turn in The People's Militia (Part 1) at Gyran Stoutmantle at the bottom of the tower \n#TURNIN3) Run to the top of the tower to turn in Patrolling Westfall \n#TURNIN4) Turn in Red Leather Bandana's at the logging house near the Inn" },
			[12] = { str = "#COORDS**If you did Hogger**:                                                                                                                                                                                                                                                                                                                                                                                            \n#TURNIN      1) #COORDSHearth to Goldshire and #TURNINturn it in outside the Inn \n#NPC      2) Train new skills \n      #ACCEPT3) Accept your level 10 class quest \n      #NPC4) Run to Stormwind \n#VIDEOIf you didn't kill Hogger, Fly to SW" },
			[13] = { str = "#TURNINTurn in “Shipment to Stormwind” near #VIDEO(56,64)", x = 56, y = 64, zone = "Stormwind" },
			[14] = { str = "#NPCTrain new weapons if you need to (and if you're level 10) at #VIDEO(57,57)", x = 57, y = 57, zone = "Stormwind" },
			[15] = { str = "#TURNIN1) Turn in “Continue to Stormwind” at #VIDEO(74,47)                                                       \n#ACCEPT2) Accept “Dungar Longdrink”", x = 74, y = 47, zone = "Stormwind" },
			[16] = { str = "#TURNIN1) Turn in “Elmore's Task” near #VIDEO(51,12)                                                                                                      \n#ACCEPT2) Accept “Stormpike's Delivery” (we turn this in on the way to the Wetlands later)", x = 51, y = 12, zone = "Stormwind" },
			[17] = { str = "#DOQUESTDo your class quest if it takes place in SW (or close by and is worth it)", x = 78, y = 45, zone = "Stormwind" },
			[18] = { str = "#TURNIN1) Turn in “Dungar Longdrink” near #VIDEO(66,62)                                                                                                                                               \n#ACCEPT2) Accept “Return to Lewis” \n#NPC3) Fly back to Westfall", x = 66, y = 62, zone = "Stormwind" },
			[19] = { str = "#TURNINTurn in “Return to Lewis” near #VIDEO(56,47)", x = 56, y = 47, zone = "Westfall" },
			[20] = { str = "#NPCFly back to SW **If you're not a warrior skip to step 18**                                                                                                                                                                                                                                                                                                                                                                                                      \n#COORDSIf you are a Warrior: \n#TURNIN      1) Turn in “A Warrior’s Training” in the bar near #VIDEO(74,37) \n#ACCEPT      2) Accept “Bartleby the Drunk” \n#TURNIN      3) Turn around and hand it in \n#ACCEPT      4) Accept “Beat Bartleby", x = 74, y = 37, zone = "Stormwind" },
			[21] = { str = "#DOQUEST1) Kick bartleby’s ass                                                                                                                   \n#ACCEPT2) Accept “Bartleby's Mug” \n#TURNIN3) Turn it in behind you to learn Defensive Stance" },
			[22] = { str = "#NPCGo into the tram and take it to Ironforge (it's near #VIDEO(63,8))", x = 63, y = 8, zone = "Stormwind" },
			[23] = { str = "#ACCEPT1) Accept “Deeprun Rat Roundup” once you get to the IF side of the tram                                                                                                                                                                                                                                                                                                                                                                                                                                                    \n#DOQUEST2) Collect 5 rats using the item in your inventory \n#TURNIN3) Turn it back in \n#VIDEO4) SKIP the next part \n #COORDS***If you wanna be a 200 IQ memer skip this and keep the flute to piss people off by playing it non-stop***" },
			[24] = { str = "#NPCGrab the FP near #VIDEO(55,47)", x = 55, y = 47, zone = "Ironforge" },
			[25] = { str = "#NPCIdeally you should be close to lvl 11" },
			[26] = { str = "#COORDSLeave IF and head into Dun Morogh" },
			[27] = { str = "#ACCEPTAccept “The Public Servant” east of IF near #VIDEO(68,55)", x = 68, y = 55, zone = "Dun Morogh" },
			[28] = { str = "#ACCEPTAccept “Those Blasted Troggs!” nearby" },
			[29] = { str = "#DOQUEST1) Kill troggs in the pitt and in the cave for both quests                                                                                                              \n#TURNIN2) Turn in The Public Servant near #VIDEO(68,55) \n#TURNIN3) Turn in Those Blasted Troggs! near #VIDEO(68,55)", x = 68, y = 55, zone = "Dun Morogh" },
			[30] = { str = "#NPCGo east toward #VIDEO(80,51)#NPC and follow the path into Loch Modan", x = 80, y = 51, zone = "Dun Morogh" },
			[31] = { str = "#ACCEPTAccept In Defense of the King's Lands (Part 1)” near #VIDEO(22,73)", x = 22, y = 73, zone = "Loch Modan" },
			[32] = { str = "#ACCEPTAccept The Trogg Threat inside the tower" },
			[33] = { str = "#NPCGrab the FP near #VIDEO(33,50)", x = 33, y = 50, zone = "Loch Modan" },
			[34] = { str = "#ACCEPTAccept “Rat Catching” from the guard wondering up the main road in Thelsamar" },
			[35] = { str = "#DOQUEST1) Kill troggs for In Defense of the King's Lands and The Trogg Threat north of and near #VIDEO(27,53)                                                                                                        \n#DOQUEST2) Kill Kobolds (north of the troggs) for Rat Catching", x = 27, y = 53, zone = "Loch Modan" },
			[36] = { str = "#TURNIN1) Turn in In Defense of the King's Land (Part 1) near #VIDEO(22,73)                                                                                                                                                                                                                                                                                                                                                            \n#ACCEPT2) Accept in Defense of the King's Land (Part 2) \n#TURNIN3) Turn in The Trogg Threat near #VIDEO(22,73) \n#TURNIN4) Turn in Rat Catching back in Thelsamar", x = 22, y = 73, zone = "Loch Modan" },
			[37] = { str = "#TURNIN1) Turn in “Stormpike's Delivery” at the north tower near #VIDEO(24,18)                                                                                                                                                                                                  \n#ACCEPT2) Accept Stormpike's Order \n#ACCEPT3) Accept Filthy Paws ", x = 24, y = 18, zone = "Loch Modan" },
			[38] = { str = "#COORDSYou should be 12 now or close to it -- you can grind if you’d like but it doesn’t matter much.                                                                                                                                                                           	                                                                                                                                                                                                                                                                                                                                              \n#NPCRun to Darkshore: \n      #COORDSYou’re going to go north through the Wetlands to Menethil Harbor, then boat to Auberdine from there (refer to NightElf guide to the Ironforge run (but do the steps backwards) if you need help)" },
		}
	},
}