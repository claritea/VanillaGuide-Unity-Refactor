...
-----------1-10 Elwynn Forest
	...
	[0110] = {
		...
		items = {
			...
			[16] = { str = "#TURNIN1) Head inside the chapel, turn in Investigate Echo Ridge at Marshal McBride \n#ACCEPT2) Accept Skirmish at Echo Ridge, then get new skills" },
			[17] = { str = "#TURNIN1) Head north of the chapel (east side) at 51,39, next to the barn and turn in Milly Osworth \n#ACCEPT2) Accept Milly's Harvest", x = 51, y = 39, zone = "Elwynn Forest" },
			[18] = { str = "#DOQUESTGo back to the field where you killed Defias and loot grapes for Milly's Harvest" },
			[19] = { str = "#DOQUESTRun NE to 56,48 for Bounty on Garrick Padfoot (need to kill named mob near the shed)", x = 56, y = 48, zone = "Elwynn Forest" },
			[20] = { str = "#TURNIN1) Turn in Milly's Harvest to Milly Osworth (51,39) \n#ACCEPT2) Accept Grape Manifest", x = 51, y = 39, zone = "Elwynn Forest" },
			[21] = { str = "#DOQUESTGo back to the Kobold Mine at 47,32 and kill Kobold Laborers for Skirmish at Echo Ridge", x = 47, y = 32, zone = "Elwynn Forest" },
			[22] = { str = "#VIDEO**Hearth**" },
			[23] = { str = "#TURNINTurn in Bounty on Garrick Padfoot to Deputy Willem" },
			[24] = { str = "#TURNIN1) Go inside the chapel, turn in Skirmish at Echo Ridge to Marshal McBride \n#ACCEPT2) Accept Report to Goldshire" },
			[25] = { str = "#DOQUESTGo to the top of the chapel through the spiral staircase and #TURNINturn in Grape Manifest" },
			[26] = { str = "#ACCEPTAs you're running out of Northshire Valley, accept Rest and Relaxation from Falkhaan Isenstrider (45,48)", x = 45, y = 48, zone = "Elwynn Forest" },
			[27] = { str = "#VIDEOGrind on mobs as you head to Goldshire (42,65)" },
			[28] = { str = "#VIDEO**You can pick up skinning/LW at the house at 47,62 if you want them**", x = 47, y = 42, zone = "Elwynn Forest" },
			[29] = { str = "#VIDEOEnter the Inn (big building) at 43,66", x = 43, y = 66, zone = "Elwynn Forest" },
			[30] = { str = "#ACCEPTAs you enter the inn, accept Kobold Candles from William Pastle (on your direct left)" },
			[31] = { str = "#TURNINTurn in Rest and Relaxation to Innkeeper Farley (near the bar)                                                                                         \n**Make Goldshire your home**" },
			[32] = { str = "#NPCExit the Inn and go to Marshal Dughan (next to blacksmithing building) \n#TURNINTurn in Report to Goldshire #ACCEPTAccept The Fargodeep Mine" },
			[33] = { str = "#NPC**Train skills** \nWarrior trainer at 41,66 (backside of BS building)", x = 41, y = 66, zone = "Elwynn Forest"  },
			[34] = { str = "#ACCEPTGo to Remy 'Two Times' (near the carts at 42,67) \nAccept Gold Dust Exchange", x = 42, y = 67, zone = "Elwynn Forest" },
			[35] = { str = "#DOQUESTRun south to the Fargodeep Mine at 39,82                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \n#DOQUESTKill Kobolds until you complete all 3 quests: \n#DOQUEST1) The Fargodeep Mine \n#DOQUEST2) Gold Dust Exchange \n#DOQUEST3) Kobold Candles \n#VIDEO**Make sure you use the lower entrance so you don't get rekt**                                                                                                                                         ", x = 39, y = 82, zone = "Elwynn Forest" },
			[36] = { str = "#DOQUESTOnce all 3 quests are done go West to the Stonefield Farm just up the hill at 34,84." },
			[37] = { str = "#ACCEPTAccept Lost Necklace \n#VIDEO**ONLY DO Princess Must Die! if you're leveling with a group, otherwise SKIP IT**", x = 34, y = 84, zone = "Elwynn Forest" },
			[37] = { str = "#NPC1) Run East to the Maclure Vinyard at #VIDEO(43,80)                         \n#ACCEPT2) Accept Young Lovers", x = 43, y = 80, zone = "Elwynn Forest" },
			[38] = { str = "#TURNIN1) Go to 43,85 and turn in Lost Necklace                                                                                                                                \n#ACCEPT2) Accept Pie For Billy \n#DOQUEST3) Kill boars until Pie for Billy is complete.", x = 43, y = 85, zone = "Elwynn Forest" },
			[39] = { str = "#TURNIN1) Run west to 34,84 and turn in Pie For Billy \n#ACCEPT2) Accept Back to Billy", x = 34, y = 84, zone = "Elwynn Forest" },
			[40] = { str = "#TURNIN1) Head west to 29,85 (near river), turn in Young Lovers \n#ACCEPT2) Accept Speak with Gramma", x = 29, y = 85, zone = "Elwynn Forest" },
			[41] = { str = "#TURNIN1) Go back to 34,84 and turn in Speak with Gramma in the house \n#ACCEPT2) Accept Note to William", x = 34, y = 84, zone = "Elwynn Forest" },
			[42] = { str = "#TURNIN1) Run back East to 43,85 (Maclure Vineyard) and turn in Back to Billy \n#ACCEPT2) Accept Goldtooth", x = 43, y = 85, zone = "Elwynn Forest" },
			[43] = { str = "#DOQUESTGo in the bottom entrance of the Fargodeep Mine at 39,82 and kill Goldtooth.                                                                                             \n#VIDEO**You should ding 7 sometime in the cave or before you came in**", x = 41, y = 78, zone = "Elwynn Forest" },
			[44] = { str = "#VIDEO**Hearth back to Goldshire**" },
			[45] = { str = "#TURNIN1) Turn in Kobold Candles at William Pastle.                                                                                                                                                                                                                                                                                                         \n#ACCEPT2) Accept Shipment to Stormwind \n3) Also turn in Note to William \n#ACCEPT4) Accept Collecting Kelp" },
			[46] = { str = "#TURNIN1)Turn in The Fargodeep Mine at Marshal Dughan                                       \n#ACCEPT2) Accept The Jasperlode Mine" },
			[47] = { str = "#TURNIN1) Turn in Gold Dust Exchange at Remy 'Two Times' (south near carts/fence).                                                                                                                                                  \n#VIDEO***You should have definitely hit lvl 7 by now*** \n#ACCEPT2) Accept A Fishy Peril" },
			[48] = { str = "#TURNIN1) Turn in A Fishy Peril at Marshal Dughan \n#ACCEPT2) Accept Further Concerns" },
			[49] = { str = "#DOQUESTKill murlocs around the lake at 51,65 for Collecting Kelp", x = 51, y = 65, zone = "Elwynn Forest" },
			[50] = { str = "#DOQUESTGrind up to the Jasperlode mine at 61,53 and run through it about half way to 60,50 to get credit for The Jasperlode Mine", x = 60, y = 50, zone = "Elwynn Forest" },
			[51] = { str = "#TURNIN1) Run to the bridge at 73,72 and turn in Further Concerns                                      #ACCEPT2) Accept Find the Lost Guards and Protect the Frontier", x = 73, y = 72, zone = "Elwynn Forest" },
			[52] = { str = "#ACCEPTStop at Sara Timberlain #VIDEO(in Eastvale Logging Camp near 79,68) and #ACCEPTAccept Red Linen Goods", x = 79, y = 68, zone = "Elwynn Forest" },
			[53] = { str = "#ACCEPTAt the center of the camp, 81,66, Accept A Bundle of Trouble", x = 81, y = 66, zone = "Elwynn Forest" },
			[54] = { str = "#DOQUEST1) Run just west of the waterfall at 72,60 touch the mangled body                                                                                                                                                                               \n#TURNIN2) Turn in Find the Lost Guards \n#ACCEPT3) Accept Discover Rolf’s Fate \n#VIDEO**If this doesn’t make you ding 8 then grind that last tiny bit**", x = 72, y = 60, zone = "Elwynn Forest" },
			[50] = { str = "#DOQUESTGo to the murloc camp at 79,55 and loot the mangled body there #VIDEO**Be careful here, might need to group**                                                                                                                                \n#TURNIN2) Turn in Discover Rolf’s Fate \n#ACCEPT3) Accept Report to Thomas", x = 79, y = 55, zone = "Elwynn Forest" },
			[51] = { str = "#TURNINGo south to 81,66 and turn in A Bundle of Trouble", x = 81, y = 66, zone = "Elwynn Forest" },
			[52] = { str = "#DOQUESTCross the road and go south and east and finish killing the bears and wolves for Protect the Frontier bears are kinda scarce so you might have to search." },
			[53] = { str = "#DOQUESTWhile doing this you can get some red bandanas for Red Linen Goods at #VIDEO(90,78) **SKIP THIS AS WARRIOR**", x = 90, y = 78, zone = "Elwynn Forest" },
			[54] = { str = "#TURNIN1) Turn in Protect the Frontier and Report to Thomas near the bridge at #VIDEO(73,72)                                          \n#ACCEPT2) Accept Deliver Thomas' Report", x = 73, y = 72, zone = "Elwynn Forest" },
			[55] = { str = "#DOQUESTGo down to the pumpkin patch at 69,78 and kill the rest of the defias for Red Linen Goods ", x = 69, y = 78, zone = "Elwynn Forest" },
			[56] = { str = "#VIDEOYou might find Furlbrow's Deed on the defias while you’re killing defias just hold it for now." },
			[57] = { str = "#TURNINGo to Sara Timberlain at #VIDEO(79,68) #TURNINand turn in Red Linen Goods                                       \n#VIDEO***Grind to 9 if you're not 9 already***", x = 79, y = 68, zone = "Elwynn Forest" },
			[58] = { str = "#ACCEPTStop at the bridge again at #VIDEO(73,72) #ACCEPTand Accept Report to Gryan Stoutmantle”                   \n#VIDEO**must be 9 to accept**", x = 73, y = 72, zone = "Elwynn Forest" },
			[59] = { str = "#VIDEO***Hearth to Goldshire***" },
			[60] = { str = "#TURNIN1) By the front door turn in Collecting Kelp \n#ACCEPT2) Accept The Escape" },
			[61] = { str = "#TURNIN1) Just outside the Inn turn in The Jasperlode Mine                                                                                                                                                                                                                                          \n2) Turn in Deliver Thomas' Report” \n#VIDEO3) SKIP “Cloth and Leather Armor” \n#ACCEPT4) Accept “Westbrook Garrison Needs Help!”" },
			[62] = { str = "#ACCEPT1) Accept “Elmore's Task” from the blacksmith house \n#NPC2) Get new skills" },
			[63] = { str = "#NPC1) Run south to the Maclure Vinyard at #VIDEO(43,89)                  \n#TURNIN2) Turn in “The Escape”", x = 43, y = 89, zone = "Elwynn Forest" },
			[64] = { str = "#NPC1) Run west to the Stonefield Farm at #VIDEO(34,84)                          \n#TURNIN2) Turn in “Goldtooth”", x = 34, y = 84, zone = "Elwynn Forest" },
			[65] = { str = "#TURNIN1) Turn in “Westbrook Garrison Needs Help!” near #VIDEO(34,74)                                                                                                                                                                    \n#ACCEPT2) Accept “Riverpaw Gnoll Bounty” \n#COORDS3) Accept Hogger if you have a group, otherwise #VIDEOSKIP IT", x = 34, y = 74, zone = "Elwynn Forest" },
			[66] = { str = "#DOQUESTKill gnolls just south of the road for “Riverpaw Gnoll Bounty”                                                                                                                                                      \n#NPC**They can also drop a gold schedule which starts a quest**" },
			[67] = { str = "#TURNINTurn in “Riverpaw Gnoll Bounty” back at #VIDEO(34,74)", x = 34, y = 74, zone = "Elwynn Forest" },
			[68] = { str = "#NPCYou should be very close to 10 now" },
			[69] = { str = "#NPCFollow the road west into Westfall" },
		}
	},
